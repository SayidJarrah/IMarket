...
import com.dkorniichuk.imarket.dao.util.ProductRowMapper;
import com.dkorniichuk.imarket.dao.util.SqlSearchQueryGenerator;
...
public class ProductDaoImpl implements ProductDao {
    ...
    private static final String SELECT_ALL_SQL = "SELECT * FROM IMarket.Product";
    private static final String SELECT_BY_ID_SQL = "SELECT * FROM IMarket.Product WHERE id_product = ?";
    private static final String INSERT_NEW_PRODUCT_SQL = "INSERT INTO IMarket.Product (id_product_category,product_name,product_price,product_image,product_description,appearance_date,available_amount) VALUES(?,?,?,?,?,?,?)";
    private static final String UPDATE_SQL = "UPDATE IMarket.Product SET product_name= ?, product_price = ?, product_description = ?, available_amount = ? WHERE id_product = ? ";
    private static final String DELETE_SQL = "DELETE FROM IMarket.Product WHERE id_product = ?";
    private static final String UPDATE_AMOUNT_SQL = "UPDATE IMarket.Product SET available_amount = ? WHERE id_product = ? ";
